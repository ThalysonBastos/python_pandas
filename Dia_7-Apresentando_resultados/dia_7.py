...
Original file is located at
    https://colab.research.google.com/drive/1zC7RzxPoKNnCBX6MNCHhMhn5bUdn9veJ
"""
...
"""Filtrando cursos selecionados abaixo

"""

cadastro_usuarios_cursos_selecionados = cadastro_usuarios_cursos.query("curso == ['BIBLIOTECONOMIA', 'CIÊNCIAS SOCIAIS', 'COMUNICAÇÃO SOCIAL']")
cadastro_usuarios_cursos_selecionados

"""Unindo DataFrames do cadastro de usuários com o de empréstimos"""

cadastro_usuarios_cursos_selecionados = matricula_data_emprestimo.merge(cadastro_usuarios_cursos_selecionados)
cadastro_usuarios_cursos_selecionados
...
"""Modificando o dado da matricula"""
...
"""Filtrando emprestimos desde 2017"""

matricula_data_emprestimo_pos_graduacao = emprestimos_completo.loc[:,['matricula_ou_siape', 'data_emprestimo']]
...
"""Unindo DataFrames de cadastro de usuários e empréstimos"""

emprestimos_pos_graduacao_desde_2017 = matricula_data_emprestimo_pos_graduacao.merge(cadastro_usuarios_cursos_pos_graduacao)
...
"""Importando mais dados " Previsão "
"""
...
"""Unindo as tabelas e incluindo a coluna 2022"""
...
"""Criando uma função para diferença de percentual"""

def diferenca_percentual_ano_anterior(x,y):
  return round(((x / y * 100)- 100),2)

"""Calculando a diferença de percentual"""
...
"""Criando DataFrame com as diferenças de percentuais"""
